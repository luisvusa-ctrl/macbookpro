...
public class Graphics : ThreadedServiceBase
{
    ...
    public void DrawFilledTriangle(Vector2 p1, Vector2 p2, Vector2 p3, Color color)
    {
        ...
        // Configura para desenhar preenchido e transparente se precisar
        _device.SetRenderState(RenderState.AlphaBlendEnable, true);
        _device.VertexFormat = VertexFormat.PositionRhw | VertexFormat.Diffuse;

        // Desenha o triângulo sólido
    ...
    public void Draw3DTube(Vector3 startWorld, Vector3 endWorld, Color color, float baseThickness, Vector3 cameraPos)
    {
        ...
        // Calcula grossura baseada na distância para manter o volume do corpo
        float distance = Vector3.Distance(cameraPos, (startWorld + endWorld) / 2f);
        float screenThickness = (baseThickness * 350f) / distance; // Ajuste o 350f para mudar o "volume" do boneco
